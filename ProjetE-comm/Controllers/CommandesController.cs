...
namespace ProjetE_comm.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public CommandesController(ProjetE_commContext context)
        {
            _context = context;
        }
        ...
        {
            var projetE_commContext = _context.Commande.Include(c => c.Panier);
        ...
        public async Task<IActionResult> Create([Bind("Id,PanierId")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PanierId")] Commande commande)
        {
            if (id != commande.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetE_commContext.Commande'  is null.");
            }
            var commande = await _context.Commande.FindAsync(id);
            if (commande != null)
            {
